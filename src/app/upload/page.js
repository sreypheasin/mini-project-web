        ...
        <div className="my-24 w-screen flex flex-col items-center justify-center">
            <Formik initialValues={{
                ...
                {({ isSubmitting, setFieldValue }) => (
                    <Form className='bg-slate-800 p-8 rounded-lgfor="dropzone-file text-white"'>

                        <div className="relative z-0 w-full mb-3 group">

                            <Field type="text" name="title" id="float_title"
                                   className="block py-2.5 px-0 w-full text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-dark dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                   placeholder=" " />
                        ...
                        {/* Avatar */}
                        <div className="z-0 mb-8 group flex items-end">
                            <Field
